...
def methode():
  ...
  if sek=="":print("\033[0;97m   [!] Isi Ranjha Yasir").format(R,N);methode()
    ...
    print("\033[0;97m   [!] Isi ALVYHASAN ").format(R,N);methode()
def logs():
  banner()
  print("\033[0;96m─────────────────────────────────────────────────────────────")
  ...
  if sek=="":
    print("\033[0;97m   [!] Isi ALVYHASAN ").format(R,N);logs()
  elif sek=="1":
    log_token()
  elif sek=="2":
    gen()
		...
		while True:
			...
			if f=="":continue
				...
				try:
					...
					print ("   %s"%e)
					continue
				print ("\033[0;96m╠══\033[0;97m[•] Example : pass123456789,pass123456789")
				self.pwlist()
				break
			elif f=="d":
				try:
